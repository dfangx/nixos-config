...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/24dd60e6-e192-4f09-8738-c9d416cc473b";
      fsType = "ext4";
    };

  fileSystems."/home" =
    { device = "/dev/disk/by-uuid/cba16500-e1ec-4b63-b321-3a433a20bcc2";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/4BD1-B9AA";
      fsType = "vfat";
    };
